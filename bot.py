...
def lalala(message):
	if message.chat.type == 'private':
		if message.text == '🧡 Мой репозиторий':
			bot.send_message(message.chat.id, 'https://github.com/ElenaBalashova-qa')
		elif message.text == '😋 Написать мне в личку':
			bot.send_message(message.chat.id, 'https://t.me/santalana')
		elif message.text == '🎧 Мой плейлист':
			bot.send_message(message.chat.id, 'https://music.yandex.ru/users/elena_sunderland@mail.ru/playlists/3')
		else:
